...
class Uploader
{
    public $imgDomain; //文件上传后的域名
    public $savePath; //上传后的保存路径
     ...
     * @return array
     */
    public function run($fileField, $type = "upload")
    {
    ...
    private function getFullName()
    {
        ...
        //替换随机字符串
        $randNum = rand(1, 99999999) . rand(1, 99999999);
    ...
    {
        $fullName = str_replace('source/','',$this->fullName);
        return [
            "msg"    => $this->stateInfo,
            "code" => $this->stateInfo == "SUCCESS" ? 0 : $this->stateInfo,
            "data"=>[
                "src"=>$this->imgDomain.$fullName,
                'title'=>$fullName,
            ],
            "type"     => $this->fileType,
            "size"     => $this->fileSize
